...
<div class="navbar justify-between bg-base-100 sticky top-0 left-0 z-10">
	<div>
		<a class="btn btn-ghost normal-case text-xl md:inline-flex hidden" href="#intro"
			>Svelte light carousel</a
		>
